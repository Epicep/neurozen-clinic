...
const MethodAuthoritySection = () => {
  return <section className="py-24 neural-mesh-bg">
          ...
          <div className="grid lg:grid-cols-5 gap-8 items-center">
            ...
            delay: 0.1
              ...
              <div className="bg-card rounded-3xl p-8 shadow-card border border-border/50">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">קליניקת NeuroZen היא כיום המקום היחיד בישראל המעניק טיפול על ידי מוסמך רשמי, הפועל בצמוד למרשמים הקליניים של מייסד השיטה, ד"ר מייקל קורדינו.</p>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                delay: 0.4
              }} className="flex items-center gap-2 px-4 py-3 rounded-xl bg-yellow-400">
                ...
                delay: 0.5
                  ...
                  <span className="text-sm font-medium text-foreground">מרשמים בינלאומיים</span>
                </motion.div>
              </div>
            </motion.div>
          </div>

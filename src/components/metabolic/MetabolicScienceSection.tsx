...
const cards = [
  ...
  {
    icon: Flame,
    title: 'טיפול ב"דלקת שקטה" וציר מעי-מוח',
    englishTitle: "Gut-Brain Axis",
    description:
      "השמנה בטנית וכבד שומני מלווים לרוב בדלקת כרונית נמוכה. הפעלת עצב הואגוס מסייעת לדיכוי המסלול הדלקתי, לשיפור תפקוד הכבד ולהרגעת רגישות המעי דרך ציר המעי-מוח (Gut-Brain Axis).",

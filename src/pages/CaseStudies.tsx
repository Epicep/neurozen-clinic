          ...
          >
            ...
            <div className="p-6 md:p-10 border-b border-border/40">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                <span className="font-medium text-foreground">מרשם:</span> סדרת טיפולי נוירופונקטורה מותאמת לוויסות המערכת הלימבית.
              </p>
            </div>

            {/* Outcomes */}
            <div className="p-6 md:p-10 border-b border-border/40">
              <p className="text-xs font-semibold tracking-wide text-muted-foreground uppercase mb-6">תוצאות מדידה</p>

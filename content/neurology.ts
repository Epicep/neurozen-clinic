...
המחקר על נוירופונקטורה בפרקינסון נמצא עדיין בשלב מוקדם.
...
במחקר הקליני הראשוני ובניסיון הקליני בקליניקה נצפה כי חלק מהמטופלים חוו שיפור בתסמינים ובתפקוד. מידת התגובה משתנה ואינה ניתנת לחיזוי מראש. לכן כבר בתחילת התהליך מוגדרות מטרות ברורות, וההתקדמות נבחנת באמצעות מדדים תפקודיים.
